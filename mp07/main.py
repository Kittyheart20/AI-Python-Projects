        ...
        while not chess.lib.isEnd(self.side, self.board, self.flags):
            ...
            if self.player[self.side] != 'human':
                ...
                if self.player[self.side] == 'random':
                    moveList, moveTree, value = submitted.random(
                        self.board, self.side, self.flags, random.choice)
                elif self.player[self.side] == 'minimax':
                    moveList, moveTree, value = submitted.minimax(
                        self.board, self.side, self.flags, self.depth[self.side])
                    ...
                    moveList, moveTree, value = submitted.alphabeta(
                        self.board, self.side, self.flags, self.depth[self.side])
                elif self.player[self.side] == 'stochastic':
                    moveList, moveTree, value = submitted.stochastic(
                        self.board, self.side, self.flags, self.depth[self.side],
