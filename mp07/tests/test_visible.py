...
def general_test(testcase, app, label, searchfunc, depth, breadth=None):
    if breadth:
        ...
        hypList, hypTree, hypVal = searchfunc(app.board, app.side, app.flags, depth, breadth, chooser)
    else:
        hypList, hypTree, hypVal = searchfunc(app.board, app.side, app.flags, depth)
